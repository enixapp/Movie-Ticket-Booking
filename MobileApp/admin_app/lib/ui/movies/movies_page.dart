...
class _MoviePageState extends State<MoviePage> {
  ...
  void didChangeDependencies() {
    ...
    _scrollController ??= ScrollController()
      ..addListener(() {
        if ((_scrollController?.position.pixels ?? 0) + 100 >=
...
class MovieCell extends StatelessWidget {
  ...
  const MovieCell(this.item, this.onToggle, [this.onTap]);
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        margin: const EdgeInsets.only(left: 6, right: 8, top: 8, bottom: 12),
                    ...
                    Row(
                      children: [
                        const Icon(Icons.star_rate_rounded,
                            size: 32, color: Color(0xff8690A0)),
