...
class AddTheatrePage extends StatefulWidget {
  ...
  const AddTheatrePage({Key? key}) : super(key: key);
...
class _AddTheatrePageState extends State<AddTheatrePage> {
  ...
  File? cover;
  File? thumbnail;
  late BuiltList<TheatreSeat> seats;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Add theatre')),
      body: Padding(
              ...
              children: [
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (newSeats is BuiltList<TheatreSeat>) {
                      seats = newSeats;
                    }
                  },
                  textTheme: ButtonTextTheme.primary,
                  child: const Text('Change seats map'),
                ),
      ...
      children: [
        Expanded(
          child: TextFormField(
            ...
            onSaved: (v) => address = v ?? "",
            validator: (v) => (v == null || v.isEmpty) ? 'Empty address' : null,
  ...
  Widget buildDescriptionFormField() {
    return TextFormField(
      ...
      autovalidateMode: AutovalidateMode.always,
      validator: (v) => (v == null || v.isEmpty) ? 'Empty description' : null,
      decoration: const InputDecoration(
        prefixIcon: Padding(
          padding: EdgeInsetsDirectional.only(end: 8.0),
  ...
  Widget buildEmailFormField() {
    return TextFormField(
      ...
      onSaved: (v) => email = v ?? "",
      validator: (v) =>
          Validator.isValidEmail(v ?? "") ? null : 'Invalid email',
      decoration: const InputDecoration(
        prefixIcon: Padding(
          padding: EdgeInsetsDirectional.only(end: 8.0),
  ...
  Widget buildNameFormField() {
    return TextFormField(
      ...
      textInputAction: TextInputAction.next,
      onSaved: (v) => name = v ?? "",
      validator: (v) => (v == null || v.isEmpty) ? 'Empty name' : null,
      decoration: const InputDecoration(
        prefixIcon: Padding(
          padding: EdgeInsetsDirectional.only(end: 8.0),
