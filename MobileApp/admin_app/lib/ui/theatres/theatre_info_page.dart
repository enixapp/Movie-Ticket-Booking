            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Divider(height: 1, color: Color(0xffD1DBE2)),
                  const SizedBox(height: 8),
                  ExpandablePanel(
                    header: Row(
                  ...
                  Row(
                    children: [
                      const Icon(Icons.phone,
                          color: Color(0xff8690A0), size: 18),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(theatre.phoneNumber ?? 'N/A',
                            style: textStyle),
                      ),
                    ],
                  ),
                  ...
                  if (theatre.email != null) ...[
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Expanded(
                          child: Text(theatre.email ?? "", style: textStyle),
                        ),
                      ],
                    ),
                    const SizedBox(height: 8),
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child:
                            Text(theatre.roomSummary ?? "", style: textStyle),
                      ),
                    ],
                  ),
                  const SizedBox(height: 8),
                  Row(
                    children: [
                      ...
                      Expanded(
                        child:
                            Text(theatre.openingHours ?? "", style: textStyle),
                      ),
                    ],
                  ),
                  if (child != null) ...[
...
class DetailAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SliverAppBar(
      ...
      floating: true,
      stretch: true,
      leading: b ? null : const BackButton(),
