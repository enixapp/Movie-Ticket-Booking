...
class _LoginPageState extends State<LoginPage>
  ...
  void initState() {
    ...
    buttonSqueezeAnimation = Tween(begin: 200.0, end: 70.0).animate(
      CurvedAnimation(
    ...
    emailController = TextEditingController(text: 'info@origon.co.jp');
  }
    ...
    return StreamBuilder<String?>(
      ...
      builder: (context, snapshot) {
        return PasswordTextField(
          errorText: snapshot.data ?? "", //"unknown error!",
