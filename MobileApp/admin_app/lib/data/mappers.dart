...
import 'package:admin_app/utils/iterable.dart';
...
User userLocalToUserDomain(UserLocal local) {
  return User(
    ...
    isCompleted: local.is_completed ?? false,
...
Theatre res_theatreResponseToTheatre(Res_TheatreResponse r) {
  return Theatre(
    location: Location(
      latitude: r.location.latitude ?? 0.0,
      longitude: r.location.longitude ?? 0.0,
    ),
    isActive: r.is_active ?? true,
